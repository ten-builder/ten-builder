...
| 폴더 | 내용 | 난이도 |
|------|------|--------|
| [`/guides`](./guides) | 1~35 단계별 + 주제별 실전 가이드 | ⭐⭐⭐ |
...
| 35 | [에이전트 스캐폴딩 설계](./guides/35-ai-agent-scaffolding-design.md) | AI 에이전트 프레임워크 설계 가이드 |
...
| [에이전틱 IDE 비교](./cheatsheets/agentic-ide-comparison-cheatsheet.md) | Kiro, Cursor, Claude Code 등 비교 |
| [AI 코드 리뷰 프롬프트](./cheatsheets/ai-code-review-prompt-cheatsheet.md) | 코드 리뷰 프롬프트 패턴 모음 |
| [Aider](./cheatsheets/aider-cheatsheet.md) | Git 네이티브 AI 코딩 에이전트 가이드 |
| [Cline](./cheatsheets/cline-cheatsheet.md) | 오픈소스 VS Code AI 에이전트 가이드 |
| [Devin AI](./cheatsheets/devin-ai-cheatsheet.md) | Cognition Devin 2.0 에이전트 가이드 |
| [Kiro IDE](./cheatsheets/kiro-ide-cheatsheet.md) | AWS 스펙 기반 에이전틱 IDE 가이드 |
| [GitHub Copilot](./cheatsheets/github-copilot-cheatsheet.md) | GitHub Copilot 필수 기능 & 패턴 |
...
| [MCP 에이전트 도구 키트](./examples/mcp-agent-toolkit) | MCP 서버 3개 조합 실전 자동화 |
| [AI 비용 모니터링](./examples/ai-cost-monitor) | AI 코딩 도구 사용량 & 비용 추적 |
| [Discord 봇 + AI](./examples/discord-bot-ai) | Discord 봇 AI 개발 |
| [Slack 봇 + AI](./examples/slack-bot-ai) | Slack 봇 AI 개발 |
| [CrewAI 멀티 에이전트](./examples/crewai-multi-agent) | CrewAI 멀티 에이전트 코딩 예제 |
...
| [AI API 문서 동기화](./workflows/ai-api-docs-sync.md) | 코드 변경 시 API 문서 자동 업데이트 |
| [AI 코드 거버넌스](./workflows/ai-code-governance.md) | AI 생성 코드 품질 & 보안 거버넌스 |
...
| [AI 에이전트 설정 최적화](./workflows/ai-agent-config-optimization.md) | AI 에이전트 설정 & 권한 최적화 |
...
| [멀티 레포 AI 개발](./claude-code/playbooks/23-multi-repo-ai.md) | 마이크로서비스 멀티 레포 동시 작업 |
| [프롬프트 체이닝](./claude-code/playbooks/24-prompt-chaining.md) | 복잡한 태스크 멀티 스텝 프롬프트 분해 |
| [장애 대응](./claude-code/playbooks/25-ai-incident-response.md) | AI로 프로덕션 장애 분석 & 핫픽스 |
| [접근성 검사](./claude-code/playbooks/26-ai-accessibility.md) | AI로 웹 접근성(a11y) 검사 & 수정 |
